        ...
        {showSuccess && (
          ...
          <div className="absolute inset-0 bg-white bg-opacity-90 flex items-center justify-center z-10 rounded-3xl animate-fade-in">
            <div className="flex flex-col items-center">
              ...
              <p className="text-xl font-semibold mt-4 text-red-500 text-center px-4">
                We are currently facing some issues please contact on +91 7808627025 or use nik.kr008@gmail.com
              </p>
            </div>
          </div>
        )}
